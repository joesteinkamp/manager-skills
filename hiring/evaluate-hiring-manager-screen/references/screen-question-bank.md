...
Reference library of follow-up questions to recommend after a hiring manager screen. These are questions for the NEXT round of interviews — not for the screen itself. Organize recommendations by what gap or concern they address.
...
- "In the design exercise, we'd like to see how you approach an ambiguous problem. Before jumping into solutions, walk us through how you'd frame the problem."
  ...
  - Strong signal: Candidate asks clarifying questions, identifies assumptions, separates user and business problems.
- "In your portfolio, show us a project where you changed the problem definition. What made you realize the original framing was wrong?"
...
- "Walk us through 2-3 directions you explored before landing on this approach. Why did you discard the others?"
  - Assign to: Portfolio review
  - Strong signal: Multiple alternatives with specific reasons for convergence.
- "In the exercise, we'll give you 45 minutes. Talk us through how you'd structure your time and what you'd prioritize."
  - Assign to: Design exercise
...
- "Walk us through the interaction details of [specific component from portfolio]. What happens on error, loading, and empty states?"
  - Assign to: Portfolio review
  - Strong signal: Fluent description of states and transitions even if not shown in portfolio.
- "In the exercise, we'll ask you to produce a mid-fidelity design. Show us how you think about visual hierarchy and interaction patterns."
  - Assign to: Design exercise
...
- "How does this feature behave at scale? What happens with 0 items, 1000 items, or when the user has no permissions?"
  ...
  - Strong signal: Anticipates boundary conditions without prompting.
- "What design system implications does your solution have? Would this create a new pattern or extend an existing one?"
  - Assign to: Design exercise
...
- "Tell me about a time you disagreed with your PM or engineer on a design direction. What happened?"
  ...
  - Strong signal: Describes both perspectives, compromise or evidence-based resolution, maintained relationship.
- "How do you run a design critique? What's your approach to giving feedback to other designers?"
  - Assign to: Cross-functional interview
...
- "For the project you discussed in the screen, what happened after launch? How did you measure success?"
  - Assign to: Portfolio review
  - Strong signal: Specific metrics, attribution awareness, post-launch iteration.
...
### Concern: Candidate spoke in generalities
- "In your portfolio, point to a specific decision you made and walk us through the evidence that informed it."
  - Assign to: Portfolio review
  - Why: Tests whether generalities in screen reflect shallow thinking or just screen nerves.

### Concern: Candidate didn't mention collaboration
- "For this project, who else was involved? Walk me through a specific design decision that changed because of input from engineering or PM."
  - Assign to: Portfolio review or cross-functional interview
  - Why: Solo narrative in a screen may reflect presentation style, not working style.
...
- "Tell me about your design process." → Too generic. Probe a specific project or gap.
- "What's your biggest weakness?" → Not relevant to design evaluation.
- Re-asking the same questions from the screen → Wastes interview time. Build on screen signal.
- "Why do you want to work here?" → Already covered in screen. Focus on unresolved competency gaps.
